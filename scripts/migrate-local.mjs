...
async function migrate() {
  ...
  try {
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS idx_badges_slug ON badges(slug);`);
    await client.query(`CREATE INDEX IF NOT EXISTS idx_awards_permalink ON awards(public_permalink);`);
